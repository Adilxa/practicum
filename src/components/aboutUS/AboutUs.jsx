...
const AboutUs = () => {
    const text = [
        "Наша программа охватывает различные направления: Project management, Mobile development, UX/UI ,Front-end и Back-end разработка. Мы предлагаем стажировку в инновационной среде, где вы сможете получить реальный опыт работы в IT и узнать все тонкости разработки программного обеспечения.",
        ...
        "Если вы готовы принять вызов и начать свою карьеру в IT, то стажировка от Solid Practicum для вас."
    ]
    return (
